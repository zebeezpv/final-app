...
- Collapsible forms on Timetable, Assessments and Study Log
- Forms automatically collapse after a successful save
- 15-minute class reminder notifications after permission is enabled in Settings
- iPhone input zoom prevention
- Countdown-based study sessions with pause, resume and automatic study-log entry
- Floating timer while a study session is active
- Newly added classes scroll into view and briefly highlight

Notification reliability depends on the browser and operating system. Keep the installed PWA active for the most reliable reminders. Fully closed-app scheduled notifications require a push notification backend or native packaging.
