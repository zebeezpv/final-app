...
export type TimetableItem={id:string;day:string;time:string;start?:string;end?:string;course:string;type:string;venue:string};
...
export type AppData={courses:Course[];semester:Semester;timetable:TimetableItem[];assessments:Assessment[];study:Study[];marks:Mark[];tasks:Task[];goals:Goal[];attendance:Attendance[];notes:Note[];resources:Resource[];revision:Revision[];reminders:Reminder[];habits:Habit[];archives:any[]};
